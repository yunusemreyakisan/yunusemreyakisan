...
<img align='right' src="https://i.hizliresim.com/d24qoj0.png" width="320" height="300" frameBorder="0" class="giphy-embed"/>
...
```javascript
const yakisan = {
  code experience: [C++, C#, Python, Dart, JavaScript, HTML/CSS],
